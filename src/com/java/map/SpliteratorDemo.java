...
/*It is included in JDK 8 for support of efficient parallel traversal(parallel programming)
 *  in addition to sequential traversal.*/
/*However, you can use Spliterator even if you won’t be using parallel execution. 
 * One reason you might want to do so is because
 */
 */